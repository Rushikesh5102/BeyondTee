    ...
    const products = [
        {
            ...
            images: JSON.stringify(['/products/mens_tee_black.png']),
        ...
        },
        {
            ...
            images: JSON.stringify(['/products/mens_oversized_black.png']),
        ...
        },
        {
            ...
            images: JSON.stringify(['/products/womens_tee_white.png']),
        ...
        },
        {
            ...
            images: JSON.stringify(['/products/womens_oversized_black.png']),
            modelPath: '/Oversized tshirt.glb',
            isCustomizable: true,
        },
        {
            ...
            images: JSON.stringify(['/products/polo_black.png']),
